...
> **Version 1** — Core RAG retrieval architecture with CLI interface.
> **Version 2 (Planned)** — FastAPI backend + web frontend with REST endpoints, chat UI, and session management.
